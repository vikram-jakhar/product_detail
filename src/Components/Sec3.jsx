...
import cardshoes from '../assests/img/small2.png'
import cardshoes2 from '../assests/img/small3.png'
const myimg = [{
img: cardshoes,
},
{
...
const Sec3 = ()=> {
        ...
        <Col lg={3} md={6} className='pb-4'>
            <div className="product-card">
              <div className="position-relative overflow-hidden">
                ...
                <p className="text-white ff-p fs-llg fw-normal lh-34 bg-off-sale position-absolute mb-0 ">
                  -10% OFF
                </p>
                <p className="text-white ff-p fs-llg fw-normal lh-34 position-absolute new-text mb-0">
                  NEW
                </p>
              </div>
              <div className="prize-detail">
                <div className="d-flex align-items-center justify-content-between">
                  <div>
                    <p className="mb-0 grey fs-1lg ff-p fw-medium lh-34">
                      Quickiins Mens Shoes
                    </p>
                    <p className="light ff-poppins fs-1lg fw-medium lh-34 mb-0">
                      $90.00 <span className="red">$70.00</span>
                    </p>
                  </div>
  ...
  return (
    <div className='py-5'>
        <Container>
            <h2 className='fs-md fw-semibold ff-poppins black pb-4'>RELATED PRODUCT </h2>
            <Row>
                {mycard}
            </Row>
        ...
        <p className="sec4-btn1 grey m-0  ff-p fs-16 lh-1 d-flex justify-content-center align-items-center "> Next{">>"}
        </p>
      </div>
        </Container>
    </div>
