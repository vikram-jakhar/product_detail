...
import pagelogo from '../assests/img/logo-f.png';
   
const Footer = () => {
  return (
    <footer class="footer-bg mt-5" id="blog">
        <Container>
      <a href="#"><img src={pagelogo} alt="logo" class="pt-4 pb-2" /></a>
      <Row className=' align-items-center '>
        <Col xl={5}>
          <p class="ff-p fs-lg fw-normal lh-185 white3  mb-2 max-448">
           ...
           <ul  className="d-flex align-items-center gap-3 pt-4 my-contact">
           <li>
           <a href="https://www.facebook.com/" target="_blank" class="text-decoration-none "><svg className='svg-f' width="35" height="35"
           ...
           <li>
           <a href="https://twitter.com/" target="_blank" class="text-decoration-none"><svg className='svg-f' width="36" height="35"
            ...
            <li>
            <a href="https://www.google.com/" target="_blank" class="text-decoration-none"><svg className='svg-f' width="36" height="35"
                viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <Col xl={7}>
          <Row className=" foot-show">
            <Col lg={3} sm={6}>
              <ul class="ps-0 mb-0">
                <li class="white3 ff-p fs-1lg fw-semibold lh-150 pt-3">
                  CUSTOM LINKS
                </li>
              </ul>
              <ul class="ps-0 mb-0 pt-4">
                <li class="mb-3">
                  <a href="#" class="text-decoration-none grey1 ff-p fs-1lg fw-normal lh-150">Lorem
                    ipsum</a>
                </li>
                <li class="mb-3">
                  <a href="#" class="text-decoration-none grey1 ff-p fs-1lg fw-normal lh-150">Lorem
            ...
            <div className='pt-5'>
            <p class="grey1 text-center ff-p fs-1lg fw-normal lh-150 footerlastline mb-0 py-4">
